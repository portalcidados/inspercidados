...
├── your_project.Rproj    # RStudio project file (optional)
│
...
│
├── notebooks/           # Exploratory analysis (Quarto/RMarkdown)
│   └── exploratory.qmd
│
├── outputs/             # Results
...
iptu <- read_csv("data/iptu_2024.csv")  # ✓
df <- read_csv("data/census_2022.csv")  # ✗
...
library(here)
data <- read_csv(here("data", "census_2022.csv"))  # ✓
data <- read_csv(here("data/census_2022.csv"))  # ✓
```
...
#          using Moran's I for São Paulo district data"
...
# 1. Context
"I'm analyzing housing prices in São Paulo using hedonic regression"
...
São Paulo housing transactions with columns (price, area_m2,
...
1. **[R for Data Science (2nd Edition)](https://r4ds.hadley.nz/)**
   - Authors: Wickham, Çetinkaya-Rundel, Grolemund
